import 'package:crm/app/modules/proposal_list/proposal_list_api_controller.dart';
...
class ProposalListPage extends StatelessWidget {
  ...
  void _onBackPressed() {
    ...
    proposalController.resetFilter();
            ...
            children: [
              ...
              Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      ...
                      proposalController.filterProposals(value);
                    },
              ...
              Expanded(
                ...
                child: Container(
                  child: Obx(
                        () {
                      if (proposalController.isLoading.value) {
                        return Center(child: CircularProgressIndicator());
                      }
                      else if (proposalController.networkError.value) {
                        return Center(child: Text('Network Error. Please check your internet connection.'));
                      }
                      else if (proposalController.proposalList.isEmpty) {
                        return Center(child: Text('No proposals available.'));
                      }
                      else {
                        final filteredProposal =
                            proposalController.filteredProposalList;
                        return ListView.builder(
                          itemCount: filteredProposal.length,
                          itemBuilder: (context, index) {
                            final proposal = filteredProposal[index];
                            // final inputTime = proposal.startTime ?? '';
                            // final inputTime2 = meeting.endTime ?? '';
                            // final formattedTime = formatTime(inputTime);
                            // final formattedTime2 = formatTime(inputTime2);

                            final String phoneNumber = "${proposal.customer?.mobileNo ?? ''}";
                                              ...
                                              children: [
                                                Container(
                                                  //width: MediaQuery.of(context).size.width * 0.65,
                                                    child: Text(proposal.customer?.businessName ?? '', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.blueGrey),)),
                                                SizedBox(height: 5,),
                                                Divider( thickness: 2, color: Colors.blueGrey,),
                                                Container(
                                                  //width: MediaQuery.of(context).size.width * 0.6,
                                                    child: Text(proposal.customer?.customerName ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18, color: Colors.black54),)),
                                                SizedBox(height: 5,),
                                                Row(
                                                  children: [
                                                    Container(
                                                      //width: MediaQuery.of(context).size.width * 0.4,
                                                        child: Text(proposal.customer?.businessRole ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                ...
                                                Container(
                                                  //width: MediaQuery.of(context).size.width * 0.4,
                                                    child: Text(proposal.customer?.mobileNo ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                SizedBox(height: 10,),
                                                Container(
                                                  //width: MediaQuery.of(context).size.width * 0.4,
                                                    child: Text(proposal.subject ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                SizedBox(height: 5,),
                                                Container(
                                                  //width: MediaQuery.of(context).size.width * 0.4,
                                                    child: Text(proposal.date ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                              ],
                                            ),
                                          ),
                                                  ...
                                                  children: [
                                                    Row(
                                                        children: [
                                                          ...
                                                          Container(
                                                              width: MediaQuery.of(context).size.width * 0.35,
                                                              child: Text(proposal.address ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                        ]
                                                    ),
                                                    SizedBox(height: 2,),
                                                    Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                              width: MediaQuery.of(context).size.width * 0.35,
                                                              child: Text(proposal.currencies?.name ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                        ]
                                                    ),
                                                    SizedBox(height: 2,),
                                                    Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                              width: MediaQuery.of(context).size.width * 0.35,
                                                              child: Text(proposal.countries?.name ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                        ]
                                                    ),
                                                    SizedBox(height: 2,),
                                                    Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                              width: MediaQuery.of(context).size.width * 0.35,
                                                              child: Text(proposal.users?.name ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                        ]
                                                    ),
                                                    SizedBox(height: 2,),
                                                    Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                              width: MediaQuery.of(context).size.width * 0.35,
                                                              child: Text(proposal.total ?? '', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.black54),)),
                                                        ]
                                                    ),
                                                    // SizedBox(height: 2,),
                                                    // Row(
