class TotalDeliverdResponse {
  List<TotalDeliveredData>? data;
  bool? status;
  String? message;

  TotalDeliverdResponse({this.data, this.status, this.message});

  TotalDeliverdResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <TotalDeliveredData>[];
      json['data'].forEach((v) {
        data!.add(TotalDeliveredData.fromJson(v));
      });
    }
    status = json['status'];
...
class TotalDeliveredData {
  ...
  TotalDeliveredData.fromJson(Map<String, dynamic> json) {
