...
import '../modules/pickupassign/model/pickupassign.dart';

class PickupListCard extends StatelessWidget {
  final PickupAssign pickupAssign;
  final VoidCallback cancel, accept;

  const PickupListCard(
      {Key? key,
        required this.pickupAssign,
      ...
      child: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(pickupAssign.trackingId.toString(),
              ...
              ListRow(
                title: 'Name',
                value: pickupAssign.businessName .toString(),
              ),
              ListMobile(
                title: 'Mobile',
                value: pickupAssign.mobile.toString(),
                press: () {
                  UrlLauncher.launchUrl(
                      Uri.parse('tel://${pickupAssign.mobile.toString()}'));
                },
              ),
              ListRow(
                title: 'Address',
                value: pickupAssign.address.toString(),
              ),
              ListRow(
                title: 'Type',
                value: pickupAssign.product.toString(),
              ),
              if (pickupAssign.pickupTime != null)
                ListRow(
                  title: 'Time',
                  value: pickupAssign.pickupTime.toString(),
                ),
              Divider(
                thickness: 2,
                color: Colors.grey,
              ...
              ListRow(
                title: 'User ID',
                value: pickupAssign.userId.toString(),
              ),
              ListRow(
                title: 'Name',
                value: pickupAssign.customerName.toString(),
              ),
              ListMobile(
                title: 'Mobile',
                value: pickupAssign.customerPhone.toString(),
                press: () {
                  UrlLauncher.launchUrl(
                      Uri.parse('tel://${pickupAssign.customerPhone.toString()}'));
                },
              ),
              ListRow(
                title: 'Address',
                value: pickupAssign.customerAddress.toString(),
              ),
              const SizedBox(
                height: 15,
              ),
