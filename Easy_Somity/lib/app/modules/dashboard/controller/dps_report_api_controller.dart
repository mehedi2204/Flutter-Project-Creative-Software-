...
import '../../dps/view/dps_report_model.dart';

class DpsCollectionReportController extends GetxController {
  ...
  Future<void> fetchDpsCollectionReport(String accessToken) async {
    try {
      isLoading.value = true;
      final response = await http.get(
        Uri.parse('${BaseUrl.basedUrl}/latest/dps-collection/report'),
        headers: {
