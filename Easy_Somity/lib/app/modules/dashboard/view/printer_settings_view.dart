...
import '../controller/loan_collection_controller.dart';
  ...
  Future<void> _connectToDevice() async {
    try {
      ...
      if (_writeCharacteristic != null) {
        ...
        Fluttertoast.showToast(
          msg: "Printer Device connected successfully.",
          toastLength: Toast.LENGTH_LONG,
          gravity: ToastGravity.CENTER,
        ...
        Fluttertoast.showToast(
          msg: "Test Invoice Data not found.",
          toastLength: Toast.LENGTH_LONG,
          gravity: ToastGravity.CENTER,
          backgroundColor: Colors.red,
          textColor: Colors.white,
  ...
  Future<void> _printInvoice() async {
    try {
      ...
      if (_writeCharacteristic != null) {
        ...
        invoiceMessage += "Account Number: 1\n";
        invoiceMessage += "Date:8/23/2023      Time:10:00 AM\n";
        invoiceMessage += "Name:Roib\n";
        invoiceMessage += "Father's Name:Rahat\n";
        invoiceMessage += "Mobile:01921510427\n";
        invoiceMessage += "Loan Collection Number:LCN2308202312\n\n\n\n\n";
      ...
      print("Error connecting to the printer: $ex");
      Fluttertoast.showToast(
        msg: "Error connecting to the printer",
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.CENTER,
        backgroundColor: Colors.red,
        textColor: Colors.white,
  ...
  Future<void> _disconnectFromDevice() async {
    try {
      if (_connectedDevice != null) {
        ...
        Fluttertoast.showToast(
          msg: "Printer Device disconnected.",
          toastLength: Toast.LENGTH_LONG,
          gravity: ToastGravity.CENTER,
          backgroundColor: Colors.green,
          textColor: Colors.white,
