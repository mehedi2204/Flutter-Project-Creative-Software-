...
import 'package:easy_somity/app/modules/dps/view/dps_invoice_view_pos_print.dart';
...
class DpsInvoiceView extends StatefulWidget {
  DpsInvoiceView({Key? key}) : super(key: key);

  @override
  State<DpsInvoiceView> createState() => _DpsInvoiceViewState();
}
...
class _DpsInvoiceViewState extends State<DpsInvoiceView> {
  ...
  Future<File> generateAndSavePDF() async {
            ...
            children: [
              ...
              pw.Row(
                children: [
                  ...
                  pw.Text(
                      '${controller.data.value.dpsCollectionNo ?? ''}',
                      style: pw.TextStyle(
                        fontWeight: pw.FontWeight.bold,
                        fontSize: 16,
                      )
                    ...
                    children: [
                      pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text(
                              '${controller.amountPerInstallment.value.amountPerInstallment ?? '0.0'}',
                              style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold,
                                fontSize: 16,
                              )
                      ...
                      pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text(
                              '${_dpsCollectionController.dpsCollectionData.value.totalReceive}',
                              style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold,
                                fontSize: 16,
                              )
                      ...
                      pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text(
                              '${controller.data.value.installmentOverdue ?? '0.0'}',
                              style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold,
                                fontSize: 16,
                              )
    ...
    final pdfFile = File("${output.path}/dps_invoice_(${controller.data.value.member!.memberName}).pdf");
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      AppText(
                        text: '${controller.data.value.member!.memberName ?? ''}',
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      AppText(
                        text: '${controller.data.value.member!.membersFatherName ?? ''}',
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      AppText(
                        text: "DPS Collection No:",
                        // fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                      AppText(
                        text: '${controller.data.value.dpsCollectionNo ?? ''}',
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                    ],
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              AppText(
                                text: '${controller.amountPerInstallment.value.amountPerInstallment ?? '0.0'}',
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
                              ),
                            ],
                          ...
                          Row(
                            ...
                            children: [
                              AppText(
                                text: "Today's Received:",
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
                              ),
                              AppText(
                                text: '${controller.data.value.installmentCollection ?? '0.0'}',
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
                              ),
                            ],
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              AppText(
                                text: '${controller.data.value.installmentOverdue ?? '0.0'}',
                                fontWeight: FontWeight.bold,
                                fontSize: 14,
                              ),
                            ],
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  AppText(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                                    color: isClose == 1? CustomColor.white: Colors.black,
                                  ),
                                ],
                              ),
                            ),
